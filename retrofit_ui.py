"""Add UI improvements to all article pages: reading progress bar + back-to-top button."""
import os
...
for fname in os.listdir(articles_dir):
    ...
    # Check if already fully retrofitted (check for the HTML element, not just CSS)
    ...
    # Add HTML + JS (check for the actual elements)
...
print(f"Articles improved: {improved}, skipped (already done): {skipped}")
